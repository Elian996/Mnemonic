...
export function RepositoryBulkDeleteList({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-black/5 bg-white/95 px-5 py-4 sm:px-7">
        ...
        return (
          ...
          >
            ...
            <WordCardPopupButton
              ...
              className="truncate text-2xl font-semibold hover:text-[#06c]"
            >
              {word.word}
            </WordCardPopupButton>
            <span className="truncate text-muted-foreground">{word.phonetic || "未填写音标"}</span>
            <Badge>{word.statusLabel}</Badge>
            <WordCardPopupButton
              slug={word.slug}
              isAuthenticated={isAuthenticated}
              defaultUserCardVisibility={defaultUserCardVisibility}
