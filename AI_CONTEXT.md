...
- Current public production version is `2.6`, set by the completed 2026-05-31 API/security/phonetic-prevention code deploy plus production-to-local data refresh.
